...
package mod.com.badlogic.gdx.backends.lwjgl.audio;
...
import mod.com.badlogic.gdx.backends.lwjgl.audio.Mp3;
import mod.com.badlogic.gdx.backends.lwjgl.audio.Ogg;
import mod.com.badlogic.gdx.backends.lwjgl.audio.OpenALAudioDevice;
import mod.com.badlogic.gdx.backends.lwjgl.audio.OpenALMusic;
import mod.com.badlogic.gdx.backends.lwjgl.audio.OpenALSound;
import mod.com.badlogic.gdx.backends.lwjgl.audio.Wav;
...
public class OpenALAudio implements Audio {
	...
	public int getSoundSourceId(long soundId) {
	    if(!soundIdToSource.containsKey(soundId)) return -1;
